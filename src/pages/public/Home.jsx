...
export const Home = () => {
  ...
  return (
    <div className="space-y-12 sm:space-y-20 lg:space-y-24 pb-16 sm:pb-20 animate-fade">
      {/* ========================================================================= */}
      {/* 1. HERO SECTION */}
      {/* ========================================================================= */}
      <section className="relative bg-white pt-8 sm:pt-14 pb-12 sm:pb-20 lg:pb-24 overflow-hidden border-b border-slate-100">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-10 xl:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          {/* Left Content */}
          <div className="lg:col-span-6 space-y-6 text-left">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 border border-blue-200 text-[#1D58D8] text-[11px] font-bold tracking-wider uppercase">
            ...
            <p className="text-slate-600 text-sm sm:text-base max-w-xl leading-relaxed">
              Faculty of Practice connects colleges, universities and training institutes with professionals who can bring real-world knowledge, practical skills and industry experience into the classroom.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              <Link
                ...
                className="px-7 py-3.5 bg-[#1D58D8] hover:bg-[#1546B8] text-white rounded-full text-xs sm:text-sm font-bold flex items-center justify-center gap-2 shadow-sm transition-transform active:scale-[0.98] cursor-pointer"
              >
                Join as an Institution <ArrowRight className="w-4 h-4" />
              </Link>
              <Link
                to="/register/expert"
                className="px-7 py-3.5 bg-white border border-slate-300 text-slate-800 hover:bg-slate-50 rounded-full text-xs sm:text-sm font-bold flex items-center justify-center gap-2 shadow-xs transition-transform active:scale-[0.98] cursor-pointer"
              >
            ...
            <div className="flex items-center gap-3 pt-1 text-xs font-semibold text-slate-700">
              <div className="flex items-center gap-1.5 text-slate-700">
                <ShieldCheck className="w-4 h-4 text-[#00BBA7]" />
                <span>Verified Professionals</span>
              </div>
              <span className="text-slate-300">|</span>
              <div className="flex items-center gap-1.5 text-slate-700">
                <Lock className="w-4 h-4 text-[#00BBA7]" />
          ...
          <div className="lg:col-span-6 flex justify-end items-end relative overflow-hidden">
            <div className="w-full max-w-xl">
              <img
                src={heroMain}
                alt="Faculty of Practice Classroom Engagement"
      ...
      <section className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-10 xl:px-12 space-y-10">
        <div className="text-center space-y-2 max-w-3xl mx-auto">
          ...
          <p className="text-slate-600 text-xs sm:text-sm leading-relaxed">
            Faculty of Practice gives institutions a simple way to discover professionals and gives industry experts a place to showcase their knowledge, experience and services.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white border border-slate-200/90 rounded-3xl p-8 sm:p-10 shadow-2xs hover:border-slate-300 transition-all flex flex-col justify-between space-y-8">
            <div className="space-y-6">
              <div className="flex items-center gap-3.5">
                ...
                <div>
                  <h3 className="text-2xl font-extrabold text-[#0F172A]">For Institutions</h3>
          ...
          <div className="bg-white border border-slate-200/90 rounded-3xl p-8 sm:p-10 shadow-2xs hover:border-slate-300 transition-all flex flex-col justify-between space-y-8">
            <div className="space-y-6">
              <div className="flex items-center gap-3.5">
                ...
                <div>
                  <h3 className="text-2xl font-extrabold text-[#0F172A]">For Industry Experts</h3>
      ...
      {/* 3. HOW IT WORKS */}
      {/* ========================================================================= */}
      <section className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-10 xl:px-12 py-4">
        <div className="bg-[#F8FAFC]/80 border border-slate-200/80 rounded-3xl p-6 sm:p-10 lg:p-14 shadow-2xs">
          {/* Header */}
          <div className="text-left space-y-2 mb-10 sm:mb-14">
            <div className="text-[#00BBA7] text-xs font-bold uppercase tracking-wider">
              SIMPLE BY DESIGN
            </div>
            <h2 className="text-3xl sm:text-4xl lg:text-[42px] font-extrabold tracking-tight text-[#0F172A] leading-tight">
              How It Works
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-0 lg:divide-x divide-slate-200/90">
            {/* Left Flow: FOR INSTITUTIONS */}
            <div className="lg:pr-10 xl:pr-16">
              <div className="text-slate-500 font-bold text-xs tracking-wider uppercase mb-8 sm:mb-10">
                FOR INSTITUTIONS
              </div>
      ...
      <section className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-10 xl:px-12 space-y-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Service 1 */}
          <div className="bg-white border border-slate-200/90 rounded-3xl p-6 sm:p-7 shadow-2xs hover:shadow-sm hover:border-slate-300 transition-all flex flex-col justify-between space-y-4">
      ...
      <section className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-10 xl:px-12 space-y-8">
        ...
        <div className="bg-slate-950 rounded-3xl p-3 sm:p-6 shadow-2xl border border-slate-800 text-slate-900">
          <div className="flex items-center justify-between pb-3 px-3 border-b border-slate-800">
            ...
            <div className="text-[10px] text-slate-500 font-semibold px-2 py-0.5 rounded bg-slate-800">
              Live SaaS Platform
            </div>
          </div>

          <div className="bg-[#F8FAFC] rounded-2xl p-5 sm:p-8 mt-3 space-y-6">
            {/* Search Bar */}
      ...
      <section className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-10 xl:px-12 space-y-10">
        ...
        <div className="bg-white border border-slate-200/90 rounded-3xl p-6 sm:p-10 shadow-2xs space-y-10">
          {/* Visual Pipeline Flow */}
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 max-w-4xl mx-auto">
            {/* Step 1: Industry */}
            <div className="flex flex-col items-center text-center p-4 bg-slate-50 border border-slate-200 rounded-2xl w-full md:w-52">
            ...
            <div className="text-slate-300 flex items-center justify-center rotate-90 md:rotate-0">
              <ArrowRight className="w-6 h-6 text-[#1D58D8]" />
            </div>

            {/* Step 2: Faculty of Practice */}
            <div className="flex flex-col items-center text-center p-5 bg-[#0F172A] text-white rounded-2xl w-full md:w-60 shadow-md">
              <div className="w-12 h-12 rounded-2xl bg-white/10 text-white flex items-center justify-center font-bold mb-2">
                <Layers className="w-6 h-6" />
              </div>
              <h3 className="text-sm font-extrabold">Faculty of Practice</h3>
            ...
            {/* Step 4: Students */}
            <div className="flex flex-col items-center text-center p-4 bg-emerald-50/50 border border-emerald-200 rounded-2xl w-full md:w-52">
      ...
      <section className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-10 xl:px-12">
        <div className="bg-[#0F172A] text-white rounded-3xl p-8 sm:p-12 lg:p-16 text-center space-y-6 shadow-xl relative overflow-hidden">
          ...
          <div className="max-w-2xl mx-auto space-y-3 relative z-10">
            ...
            <p className="text-slate-300 text-xs sm:text-sm sm:leading-relaxed pt-1">
              Whether you are an institution looking for practical expertise or a professional ready to share your experience, Faculty of Practice gives you a place to connect.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-4 relative z-10">
            <Link
              to="/register/institution"
              className="w-full sm:w-auto px-8 py-3.5 bg-[#1D58D8] hover:bg-[#1546B8] text-white rounded-full text-xs sm:text-sm font-bold shadow-sm transition-transform active:scale-[0.98] cursor-pointer"
            >
              Join as an Institution
            </Link>
            <Link
              to="/register/expert"
              className="w-full sm:w-auto px-8 py-3.5 bg-white/10 hover:bg-white/15 text-white border border-white/20 rounded-full text-xs sm:text-sm font-bold shadow-xs transition-transform active:scale-[0.98] cursor-pointer"
            >
              Join as an Industry Expert
            </Link>
          </div>
